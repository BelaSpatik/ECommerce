...
Para este proyecto busqué muchas referencias actuales de diferentes ecommerce de librerías para tomar inspiración y elementos comunes al momentos de pensar la estructura de la aplicación web.\
El diseño lo construí a partir de una paleta básica de tres coleres principales (negro, blanco y verde), dos secundarios (gris y rojo) y un estilo geométrico que permea a cada elemento. No utilizé librerías de CSS.\
