...
const catalog = [
  // simular una base de datos (api)
  {
    ...
    price: "1600",
    //genre: ["Literatura Universal", "Segunda Guerra Mundial", "Drama"],
    genre: [["01", "31", "29"],["Literatura Universal", "Segunda Guerra Mundial", "Drama"]],
    pictureurl: Zusak,
    editorial: "Lumen",
  ...
  },
  {
    ...
    price: "890",
    //genre: ["Literatura Universal", "Drama"],
  ...
  },
  {
    ...
    price: "1200",
    genre: [["02", "29"],["Literatura Latinoamericana", "Drama"]],
    pictureurl: Rulfo,
    editorial: "RM",
    encuadernacion: "Tapa blanda",
    pags: 136,
...
const ItemDetailContainer = () => {
  ...
  const getItems = () => {
      const item = new Promise((success) => {
        setTimeout(() => {
          success(catalog)
        }, 2000);
      });
